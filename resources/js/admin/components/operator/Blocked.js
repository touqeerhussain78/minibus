...
class Blocked extends Component {
    ...
    handleClick(type, id){
        ...
        if(type == 'view'){
            this.props.history.push("/operators/view"+id);
        }else{
            history.push("/operators/edit"+id);
        }
    }
    ...
    fetchUsers(blocked=false){
        var url = 'api/operator?blocked=true';
        axios.get(url)
        .then((response) => {
    ...
    async onPage(selectedPage){
        ...
        await axios.get(`api/operator?blocked=true&page=${ page }`)
            .then((response) => {
    ...
    render(){
        return (
            <>
            <Helmet> <title>Minibus - Blocked Operators</title> </Helmet>
                                ...
                                <div className="card-body card-dashboard">
                                    <div className="row">
                                        <div className="col-lg-6 col-12">
                                            <h1 className="pull-left">Blocked Operator list</h1>
                                        </div>
                                        <div className="content-header-right breadcrumbs-right breadcrumbs-top col-lg-6 col-12">
                                            <div className="breadcrumb-wrapper col-12">
                                                <ol className="breadcrumb">
                                                    <li className="breadcrumb-item"><Link to="operator">Operators</Link></li>
                                                    <li className="breadcrumb-item active">Blocked Operators</li>
                                                </ol>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="top">
                                        <div className="row">
                                            <div className="col-xl-4 offset-xl-8 offset-lg-7 offset-md-4 col-lg-5 col-md-8 col-12 order-lg-1 order-2">
                                                <a className="pur" onClick={ () => this.props.history.push('/operators')}><i className="pur"></i>All Operators</a>
                                            </div>
