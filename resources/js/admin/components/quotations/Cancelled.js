...
class Cancelled extends Component {
    ...
    fetchData(){
        axios.get('/api/quotations/cancelled/'+this.props.id)
            .then((response) => {
    ...
    refund(id){
        ...
        axios.get('/api/quotations/refund/'+ id)
            .then((response) => {
    ...
    render(){
        return (
            <>
            <Helmet> <title>Minibus - Cancelled Quotations</title> </Helmet>
                    ...
                    <div className="card-content collapse show">
                        ...
                        <div className="row ">
                            <div className="col-md-6">
                                <h1 className="pull-left">Cancelled Requests</h1>
                            </div>
                            <div className="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
                                <ol className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active"> Cancelled Quotation</li>
                                </ol>
                            </div>
                        </div>
                        <div className="row">
                                ...
                                <div className="qutation-right q-acc-right">
                                    ...
                                    <div className="row">
                                        <div className="col-12">
                                            ...
                                            {this.state.quotation.is_refund == 0 ?
                                                <div className="refund-box"> 
                                                    <h4>Refund to: 20% To Operator</h4>	
                                                    <h3>Refund Not Paid</h3>
                                                    <button onClick={() => this.refund(this.state.quotation.id) } >mark as paid</button>
                                                </div> 
