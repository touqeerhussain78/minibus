...
class Confirmed extends Component {
    ...
    fetchData(){
        axios.get('/api/quotations/confirmed/'+this.props.id)
            .then((response) => {
    ...
    render(){
        return (
            <>
            <Helmet> <title>Minibus - Confirmed Quotations</title> </Helmet>
                ...
                <div className="col-12">
                    ...
                    <div className="card-content collapse show">
                        ...
                        <div className="row ">
                            ...
                            <h1 className="pull-left">Accepted Quotations</h1>
                            </div>
                            <div className="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
                                <ol className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active"> Accepted Quotations</li>
                                </ol>
                            </div>
                        </div>
                        <div className="row">
                                ...
                                <div className="qutation-right q-acc-right">
                                    ...
                                    <div className="row">
                                        <div className="col-12">
                                            ...
                                            <h6>Payment Status: Security Deposit Paid - £{ this.state.security_deposit} /</h6>
                                                <h6>Amount Remaining: £{ this.state.amount_remaining}</h6>
                                            <h5>Operator for this trip</h5>
                                                ...
                                                <p><i className="fa fa-money"></i>Trip Amount: <b>£{ this.state.quote.amount}</b></p>
                                            </div> 
                                            ...
                                            {/* <div className="refund-box"> 
                                                ...
                                                <h4>Refund to: 20% To Operator</h4>	
                                                <h3>Refund Not Paid</h3>
