...
class Accepted extends Component {
    ...
    fetchData(){
        axios.get('/api/quotations/accepted/'+this.props.id)
            .then((response) => {
    ...
    render(){
        ...
        return (
            <>
            <Helmet> <title>Minibus - Accepted Quotations</title> </Helmet>
            
            <section id="configuration" className="search view-cause quatation-request q-accept acce">
                <div className="row">
                    ...
                    <div className="card-content collapse show">
                        ...
                        <div className="row ">
                            <div className="col-md-6">
                                <h1 className="pull-left">Awaiting confirmation</h1>
                            </div>
                            <div className="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
                                <ol className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active"> Awating confirmation</li>
                                </ol>
                            </div>
                        </div>
                        <div className="row">
                            ...
                            <div className="box red w-100">
                                ...
                                <h3>waiting for operator status</h3>
                            </div>
                            </div> 
                                ...
                                <div className="qutation-right q-acc-right">
                                    ...
                                    <div className="row">
                                        <div className="col-12">
                                            ...
                                            <h6>Payment Status: Security Deposit Payment on hold</h6>
                                                <h6>Remaining Amount: £{ this.state.security_deposit}</h6>
                                            <h5>Operator for this trip</h5>
                                                <img src={ this.state.operator.image ? this.state.operator.image : window.base_url + '/administrator/images/Profile_03.png'} className="img-fluid" alt="" /> 
                                                ...
                                                <p><i className="fa fa-money"></i>Trip Amount: <b>£{ this.state.quote.amount ? this.state.quote.amount : ''}</b></p>
                                            </div> 
