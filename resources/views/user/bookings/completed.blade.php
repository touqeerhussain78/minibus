...
<section class="booking-detail cancle-trip completed-trip-detail p-100 ">
                    ...
                    <div class="right">
                        ...
                        <div class="row">
                            ...
                            <div class="qu-box"> 
                                ...
                                <h3>Minibus Type</h3>
                                <ul class="border-b">
                                    <li>Model: <span>{{ $quote->operator->minibus[0]['Model l'] }}</span>
                                    </li>
            ...
            <div class="col-12">
              <div class="cancled-box yel">
                  <div class="d-xl-flex justify-content-between">
                    <h3>Operator has marked this trip as completed</h3>
                    {{-- <a href="#" class="pur">report this <img src="{{ asset('/frontend/images/arrow.png') }}" alt=""></a> --}}
                  </div>
                  <br/>
                  <h4>Rate operator: <div name="rating" id="rating" data-rate-value=0></div></h4>
                  
                     
                          <div class="row">
                              <div class="col-12 form-group position-relative">
                                  <textarea id="comments" cols="" placeholder="Give operator feedback" rows="" class="form-control"></textarea>
                                  {{-- <i class="fa fa-comments"></i> --}}
                              </div>
                          </div>
                            <div class="row">
                                <div class="col-12 text-center blockui">
                                    <button type="button" class="pur" onclick="rate({{$quote->operator_id}}, {{$quote->booking_id}})">post review<img src="{{ asset('/frontend/images/arrow.png') }}" alt=""></button>
                                </div>
                            </div>
...
@section('js')
<script src="{{ asset('/frontend/js/rater.min.js') }}"></script>
<script>
$(function () {
