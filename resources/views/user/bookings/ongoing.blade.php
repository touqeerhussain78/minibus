...
<section class="booking-detail cancle-trip confirm-trip ongoing p-100 ">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="cancled-box yel">
                        <h3>Operator has marked this trip as started</h3>
                        <a href="#" class="pur" data-toggle="modal" data-target="#exampleModalCenter">Report<img src="images/arrow.png" alt=""> </a>
                    </div>
                </div>
            </div>
...
<div class="modal fade report-modal" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="forget-pass">
                <div class="modal-header">
                    <h1>Please specify reasons for report</h1>
                ...
                <div class="modal-body">
                    ...
                    <form action="">
                        ...
                        <div class="row">
                            ...
                            <label class="login-radio">{{ $row->title }}<input type="radio" id="cat-id" value="{{ $row->id }}" checked="checked" name="radio"><span class="checkmark"></span></label>
                                @endforeach
                            </div>
                            <div class="col-12 form-group">
                                <textarea id="comments" placeholder="If other, then please specify" class="form-control"></textarea>
                                <i class="fa fa-comments"></i> </div>
                            <div class="col-12 text-center">
                                <button type="button" class="yel"  onclick="report({{$quote->booking_id}}, {{$quote->operator_id}})" > Report this operator <img src="images/arrow.png" alt=""></button>
                            </div>
                        </div>
                    </form>
                </div>
