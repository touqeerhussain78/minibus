...
<section class="o-operator-quot p-100">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2>Special Invites</h2>
                <p>These users want you to be their operator</p>
            </div>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group mr-1 mb-1">
                                        ...
                                        <a class="dropdown-item" href="{{ route('operators.quotations.show', $row->booking['id']) }}"><i class="fa fa-eye"></i>View </a>
