...
<h1>Dear subscriber <br /></h1>
<p>Thank you for getting in touch!</p><br />
<p>You are successfully subscribed to My Therapy Talk.</p><br/>
<p>Have a great day ahead!</p><br/>
<!-- Action -->
...
<td>
{{-- @if(isset($action))
<a href="{{ url('/')}}login" class="button button--" target="_blank">
Login
...
<p>If you have any other questions, feel free to <a href="mailto:{{env('APP_EMAIL')}}">email our customer support team</a>. (We're lightning quick at replying.)
<p>Thanks,
